drop function if exists public.claim_gelato_sync_job_items(uuid, integer);
...
grant execute on function public.claim_gelato_sync_job_items(integer, uuid) to anon, authenticated, service_role;
