...
export function toResponseRow(row: GenerationRow | null) {
  ...
  return {
    ...
    backgroundRemovalStatus: row.background_removal_status,
    backgroundRemovalPredictionId: row.background_removal_prediction_id,
    backgroundRemovalError: row.background_removal_error,
