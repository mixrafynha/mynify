...
import GelatoColorSyncPage from "./ui";
import AdminGuard from "@/app/components/admin/AdminGuard";
import AdminHeader from "@/app/components/admin/AdminHeader";
import { useAdminDashboard } from "@/hooks/useAdminDashboard";

export default function GelatoColorSyncAdminPage() {
    ...
    return (
      <div className="min-h-screen bg-[#f7f7fb] px-4 py-10 text-[#111]">
        <div className="mx-auto max-w-3xl rounded-[28px] border border-black/5 bg-white p-6 shadow-sm">
          <p className="animate-pulse text-sm font-black text-black/45">Loading Gelato color sync...</p>
        </div>
      </div>
    );
  }
