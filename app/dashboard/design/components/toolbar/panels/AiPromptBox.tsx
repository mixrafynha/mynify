    ...
    <div className="space-y-3 text-white">
      <div className="flex items-center gap-2">
        ...
        <div className="min-w-0">
          <h2 className="text-sm font-black leading-none">AI Design Studio</h2>
          <p className="mt-1 text-[11px] font-medium text-slate-500">PNG transparente para print</p>
        </div>
      </div>
      ...
      {(notice || error) && (
        <div className={`rounded-2xl px-3 py-2 text-xs font-bold ${error ? "bg-red-500/10 text-red-200 ring-1 ring-red-500/20" : "bg-violet-500/10 text-violet-100 ring-1 ring-violet-400/20"}`}>
          {error || notice}
        </div>
      )}
