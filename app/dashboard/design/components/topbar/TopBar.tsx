...
function TopBar({
  ...
  return (
    <>
      <header className="sticky top-0 z-50 h-[50px] w-full shrink-0 overflow-hidden border-b border-white/[0.07] bg-[#05050d]/92 text-white shadow-[0_8px_24px_rgba(0,0,0,.28)] backdrop-blur-2xl supports-[backdrop-filter]:bg-[#05050d]/78">
