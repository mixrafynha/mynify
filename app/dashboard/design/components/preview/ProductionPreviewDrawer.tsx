...
function ProductionPreviewDrawer({
  ...
  useEffect(() => {
    ...
    document.body.classList.add("ryfio-preview-open");
    document.documentElement.classList.add("ryfio-preview-open");
    ...
    return () => {
      document.body.classList.remove("ryfio-preview-open");
      document.documentElement.classList.remove("ryfio-preview-open");
  ...
  return createPortal(
    <div
      data-ryfio-preview-overlay="true"
