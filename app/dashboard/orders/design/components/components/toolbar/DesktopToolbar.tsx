...
export default function DesktopToolbar({
  ...
  const handleUploadChange = useCallback(
    async (e: React.ChangeEvent<HTMLInputElement>) => {
      ...
      try {
        const quality = (/\.svg$/i.test(file.name) || file.type === "image/svg+xml")
        ? { ok: true, message: "SVG vector accepted. Transparency preserved." }
        : await validatePrintImage(file);
        ...
        if (quality.label !== "PRO") {
          console.info("Upload image quality:", quality.message);
        }
