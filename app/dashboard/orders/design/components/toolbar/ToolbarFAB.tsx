  ...
  const createElement = (data: unknown) => {
    ...
    const element: ElementItem = {
      ...
      meta: {
        ...
        dpiTarget: 400,
        dpi: item.type === "text" || item.type === "shape" || item.type === "svg" || item.type === "qr" || item.type === "barcode" ? 400 : item.meta?.dpi,
        effectiveDpi: item.type === "text" || item.type === "shape" || item.type === "svg" || item.type === "qr" || item.type === "barcode" ? 400 : item.meta?.effectiveDpi,
        qualityStatus: item.type === "text" || item.type === "shape" || item.type === "svg" || item.type === "qr" || item.type === "barcode" ? "Excellent" : item.meta?.qualityStatus ?? "Unknown",
